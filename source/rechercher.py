...
def rechercher_pays():
    ...
    if str(code) in data:
        ...
        info_label['text']="Les informations du pays de code " + str(code)
...
retour_btn.pack(side=LEFT,pady=10)
liste_btn.pack(side=RIGHT,pady=10,padx=5)


info_label = Label(info_wrapper, text="Veuillez saisir le code d'un pays puis appuyer rechercher ", padx=5,font=header_font)
info_label.pack()
